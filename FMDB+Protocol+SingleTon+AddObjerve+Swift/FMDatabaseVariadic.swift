...
extension FMDatabase {
    ...
    func executeQuery(sql:String, _ values: AnyObject...) -> FMResultSet? {
        return executeQuery(sql, withArgumentsInArray: values as NSArray as [AnyObject]);
    }
    ...
    func executeUpdate(sql:String, _ values: AnyObject...) -> Bool {
        return executeUpdate(sql, withArgumentsInArray: values as NSArray as [AnyObject]);
    }
}
